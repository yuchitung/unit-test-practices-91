...
class Calculator
{
    ...
    protected function calculatedByBlackCat()
    {
        $this->companyName = "黑貓";
        $weight = $this->weight;
        if ($this->weight > 20) {
    ...
    protected function calculatedByHsinchu()
    {
        $this->companyName = "新竹貨運";
        $length = $this->length;
        $width = $this->width;
    ...
    protected function calculatedByPostOffice()
    {
        $this->companyName = "郵局";
        $weight = $this->weight;
        $feeByWeight = 80 + $weight * 10;
